(function ($) {
    ...
    var amountprice_min = $('#amount-min');
    var amountprice_max = $('#amount-max');
    $(function() {
        sliderrange.slider({
            range: true,
            min: 400,
            ...
            slide: function(event, ui) {
                amountprice_min.val(ui.values[0]);
                amountprice_max.val(ui.values[1]);
            }
        });
        amountprice_min.val(sliderrange.slider("values", 0));
        amountprice_max.val(sliderrange.slider("values", 1));
